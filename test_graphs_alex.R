...
characters <- read_csv("Documents/GitHub/the-simpsons/data/simpsons_characters.csv")
episodes <- read_csv("Documents/GitHub/the-simpsons/data/simpsons_episodes.csv")
locations <- read_csv("Documents/GitHub/the-simpsons/data/simpsons_locations.csv")
script_lines <- read_csv("Documents/GitHub/the-simpsons/data/simpsons_script_lines.csv")

bing <- read_csv("Documents/GitHub/the-simpsons/data/Bing.csv")
nrc <- read_csv("Documents/GitHub/the-simpsons/data/NRC.csv")
afinn <- read_csv("Documents/GitHub/the-simpsons/data/Afinn.csv")
