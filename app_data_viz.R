...
server <- function(input, output) {
  ...
  characters <- read_csv("data/simpsons_characters.csv", col_select=c("id", "normalized_name", "gender"))
  episodes <- read_csv("data/simpsons_episodes.csv", col_select=c("id", "season"))
  locations <- read_csv("data/simpsons_locations.csv", col_select=c("id", "normalized_name"))
  script_lines <- read_csv("data/simpsons_script_lines.csv", col_select=c("id", "episode_id", "timestamp_in_ms", "speaking_line", "character_id", "location_id","normalized_text", "word_count"))
